...
import './UnfollowTheLeader.css'

export default function UnfollowTheLeader() {
  ...
  const [best, setBest] = useState(() => getBest('unfollow-the-leader'))
  ...
  return (
    <div className="game">
      <header className="game__hud">
        ...
        {best !== null && (
          <span className="game__stat game__stat--best">
            Best {formatBest('unfollow-the-leader', best)}
          </span>
        )}
      </header>
      ...
      <div className="game__stage">
        {phase === 'idle' && (
          <div className="panel">
            <h1 className="panel__title">Unfollow the Leader</h1>
            <p className="panel__text">
              Watch the grid. A sequence of tiles will light up. Tap them back
              in <strong>reverse</strong> order. Each round adds one more tile
        ...
        {phase === 'countdown' && (
          <div className="panel">
            ...
            <div className="utl-countdown">{countdown || 'Go!'}</div>
          </div>
        )}
        ...
        {(phase === 'show' || phase === 'input' || phase === 'roundResult') && (
          <div className="panel panel--wide">
            ...
            {phase === 'input' && (
              <p className="panel__label">Tap in reverse order</p>
            )}
            {phase === 'roundResult' && (
        ...
        {phase === 'gameover' && (
          <div className="panel">
            ...
            <div className="utl-summary">
              <div className="utl-summary__row">
